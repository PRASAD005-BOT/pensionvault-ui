...
const nav = [
  ...
  { label: 'Remittances', to: '/remittances',  icon: <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg> },
  ...
  return (
    <>
      ...
      <div className="sidebar-brand" style={{ display: 'flex', alignItems: 'center', justifyContent: isCollapsed ? 'center' : 'space-between', padding: isCollapsed ? '20px 0' : '20px 24px' }}>
        ...
        <button className="icon-btn" onClick={() => setIsCollapsed(!isCollapsed)} title="Toggle Sidebar" style={{ padding: 4, background: 'none', border: 'none', color: 'var(--text-muted)' }}>

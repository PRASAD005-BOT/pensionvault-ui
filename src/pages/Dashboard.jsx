    ...
    return (
      <div className="page-body">
        ...
        <div className="stats-grid">
          <StatCard label="Total EPF Balance" value={formatINR(balance)} color="blue" icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>} />
  ...
  return (
    <div className="page-body">
      ...
      <div className="stats-grid">
        ...
        <StatCard label="Total Corpus" value={formatINR(corpus)} color="green" icon={<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>} />
      </div>
